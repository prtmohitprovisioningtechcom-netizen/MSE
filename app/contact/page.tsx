  ...
  const offices = [
    {
      ...
      address: 'Plot No. C-12, G-Block, MSECCIA House, Bandra Kurla Complex (BKC), Mumbai, MH 400051',
    ...
    <div className="py-12 px-6 max-w-7xl mx-auto space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-6 bg-gradient-to-br from-primary to-slate-900 text-white rounded-3xl space-y-4 shadow-xl relative overflow-hidden text-xs">
      ...
      <div className="space-y-4">
        ...
        <div className="w-full h-80 rounded-3xl bg-slate-200 relative overflow-hidden shadow-sm border border-slate-100 flex items-center justify-center text-center p-6 text-slate-500">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-slate-200/50 via-slate-300 to-slate-400 opacity-80" />
          ...
          <div className="relative z-10 space-y-3 max-w-sm">
            ...
            <h4 className="font-bold text-slate-900 text-sm">MSECCIA BKC Office Complex</h4>
